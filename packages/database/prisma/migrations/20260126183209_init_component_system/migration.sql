-- CreateTable Tenant (already exists, skipping)
...
-- CreateIndex
CREATE INDEX "ComponentDefinition_type_idx" ON "ComponentDefinition"("type");
CREATE INDEX "ComponentDefinition_category_idx" ON "ComponentDefinition"("category");

-- CreateIndex
CREATE INDEX "ComponentDefinitionVersion_componentId_idx" ON "ComponentDefinitionVersion"("componentId");

-- CreateIndex
CREATE INDEX "ComponentCompositionDefinition_parentComponentId_idx" ON "ComponentCompositionDefinition"("parentComponentId");

-- CreateIndex
CREATE INDEX "ComponentStyle_componentId_idx" ON "ComponentStyle"("componentId");

-- CreateIndex
CREATE INDEX "TenantComponentStyle_tenantId_idx" ON "TenantComponentStyle"("tenantId");
CREATE INDEX "TenantComponentStyle_customComponentId_idx" ON "TenantComponentStyle"("customComponentId");

-- CreateIndex
CREATE INDEX "JavaScriptFunctionTemplate_componentId_idx" ON "JavaScriptFunctionTemplate"("componentId");

-- CreateIndex
CREATE INDEX "JavaScriptFunction_templateId_idx" ON "JavaScriptFunction"("templateId");
CREATE INDEX "JavaScriptFunction_pageId_idx" ON "JavaScriptFunction"("pageId");
CREATE INDEX "JavaScriptFunction_tenantId_idx" ON "JavaScriptFunction"("tenantId");
...
CREATE INDEX "PageVersion_status_idx" ON "PageVersion"("status");

-- CreateIndex
CREATE INDEX "Zone_templateId_idx" ON "Zone"("templateId");

-- CreateIndex
CREATE INDEX "Template_pageId_idx" ON "Template"("pageId");

-- CreateIndex
CREATE UNIQUE INDEX "PreviewAccess_pageVersionId_userId_key" ON "PreviewAccess"("pageVersionId", "userId");
CREATE INDEX "PreviewAccess_pageVersionId_idx" ON "PreviewAccess"("pageVersionId");

-- CreateIndex
CREATE INDEX "ComponentVersionHistory_componentId_idx" ON "ComponentVersionHistory"("componentId");

-- CreateIndex
CREATE INDEX "VersionNotification_historyId_idx" ON "VersionNotification"("historyId");
CREATE INDEX "VersionNotification_tenantId_idx" ON "VersionNotification"("tenantId");
CREATE INDEX "VersionNotification_acknowledged_idx" ON "VersionNotification"("acknowledged");

-- CreateIndex
CREATE UNIQUE INDEX "TenantCustomComponent_tenantId_slug_key" ON "TenantCustomComponent"("tenantId", "slug");
CREATE INDEX "TenantCustomComponent_tenantId_idx" ON "TenantCustomComponent"("tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "TenantComponentVersion_componentId_version_key" ON "TenantComponentVersion"("componentId", "version");
